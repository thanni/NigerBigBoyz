    ...
    */
    $('.price-row').click(function(){
		...
		*/
        ...
        if(totalBridePrice >= 25){ 
            $('#elder-comment').html('Big Boy');
        ...
        else if (totalBridePrice >= 15){ 
            $('#elder-comment').html('I better pass my Neighbor');
        ...
        //     $('#elder-comment').html('You have pass.');
        //     $('#fb-comment').html('Wife levels has passed WAEC. 5 credits.');
        //     $('#tw-comment').html('5 Credit WAEC pass');

        // }
        // else if (totalBridePrice >= 50000) {
        //     $('#elder-comment').html('Napako We recommend two weeks of dry fasting and prayers for improvement.');
